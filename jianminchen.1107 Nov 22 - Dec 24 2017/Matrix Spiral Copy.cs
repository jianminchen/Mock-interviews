...
// what we can do is to get audio from other places, like you appear.in or call my skype phone number if you are in north america 
// yes, I do have wechat -> juliayichun
// let us get audio from wechat then, id: juliayichun
// I accepted, you can give me an audio call 
// you can turn on speaker, so you do not need to hold the phone 
// clockwise 
